...
class Widget_Rangers_Single_About extends WP_Widget {
    
    public function __construct() {
        $widget_args = [
            'classname' => 'widget_rangers_single_about',
            'description' => __('Our Latest Footer WIDGETS'),
            'customize_selective_refresh' => true,
        ];

        parent::__construct('widget_rangers_single_about', __('Footer About widget'), $widget_args);
        $this->alt_option_name = 'widget_rangers_single_about';
    }
...
register_widget('widget_rangers_single_about');
?>
